...
class MyDataset():
    def build_file_list(self, subj):
        ...
        audio_subject_list = np.load('/ai/benchmark3/fusion_baseline_231205_new/audio_subject.npy')
        audio_subject_list = audio_subject_list.tolist()

        lip_subject_list = np.load('/ai/benchmark3/fusion_baseline_231205_new/lip_subject.npy')
        lip_subject_list = lip_subject_list.tolist()

        emg_subject_list = np.load('/ai/benchmark3/fusion_baseline_231205_new/emg_subject.npy')
        emg_subject_list = emg_subject_list.tolist()

    
        audio_dataset = audio_subject_list[subj]
        lip_dataset = lip_subject_list[subj]
        emg_dataset = emg_subject_list[subj]
