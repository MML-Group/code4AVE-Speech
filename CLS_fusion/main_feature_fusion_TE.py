...
def train_test(audio_model, lip_model, emg_model, concat_model, dset_loaders, criterion, epoch, phase, optimizer, args, logger, use_gpu, save_path):
    ...
    if phase == 'train':
        ...
        torch.save(concat_model.state_dict(), save_path+'/Transformer_'+args.mode+'_'+str(epoch+1)+'.pt')
...
def main():
    ...
    parser.add_argument('--audio-path', default='/ai/exp3/fusion_baseline_231205_new/audio_only/finetuneGRU_67.pt', help='path to pre-trained audio model')
    parser.add_argument('--lip-path', default='/ai/exp3/fusion_baseline_231205_new/video_only/finetuneGRU_every_frame/finetuneGRU_0906_22.pt', help='path to pre-trained lip model')
    parser.add_argument('--emg-path', default='/ai/exp3/fusion_baseline_231205_new/emg_only/finetuneGRU_every_frame/finetuneGRU_245.pt', help='path to pre-trained emg model')
    parser.add_argument('--concat-path', default='/ai/exp/fusion_baseline_231205_new/finetuneGRU_every_frame/Transformer_finetuneGRU_2.pt', help='path to pre-trained concat model')
