...
from emg_dataset_subject import *
...
def main():
    ...
    parser.add_argument('--path', default='/ai/benchmark/fusion_baseline_231205_new/emg_only/finetuneGRU_every_frame/finetuneGRU_245.pt', help='path to model')
